...
IMG ?= aveshasystems/kubeslice-controller:latest-feature-apirepo
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	$(CONTROLLER_GEN) rbac:roleName=controller-role crd webhook paths="./vendor/github.com/kubeslice/apis/..." output:crd:artifacts:config=config/crd/bases 
.PHONY: generate
