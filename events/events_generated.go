...
var EventsMap = map[events.EventName]*events.EventSchema{
	...
	"VPNKeyRotationConfigConfigDeletedForcefully": {
		Name:                "VPNKeyRotationConfigConfigDeletedForcefully",
		Reason:              "VPNKeyRotationConfigConfigDeletedForcefully",
		Action:              "DeleteVPNKeyRotationConfig",
		Type:                events.EventTypeWarning,
		ReportingController: "controller",
		Message:             "VPNKeyRotationConfig config got deleted forcefully.",
	},
}
...
var (
	...
	EventVPNKeyRotationConfigConfigDeletedForcefully events.EventName = "VPNKeyRotationConfigConfigDeletedForcefully"
)
