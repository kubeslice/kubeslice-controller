...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSubnet) DeepCopyInto(out *ClusterSubnet) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSubnet.
func (in *ClusterSubnet) DeepCopy() *ClusterSubnet {
	if in == nil {
		return nil
	}
	out := new(ClusterSubnet)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IPAMAllocation) DeepCopyInto(out *IPAMAllocation) {
	*out = *in
	if in.RequestedSubnetSize != nil {
		in, out := &in.RequestedSubnetSize, &out.RequestedSubnetSize
		*out = new(string)
		**out = **in
	}
	if in.Labels != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPAMDeallocation) DeepCopyInto(out *IPAMDeallocation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPAMDeallocation.
func (in *IPAMDeallocation) DeepCopy() *IPAMDeallocation {
	if in == nil {
		return nil
	}
	out := new(IPAMDeallocation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IPAMPoolStatus) DeepCopyInto(out *IPAMPoolStatus) {
	*out = *in
	if in.AllocatedSubnets != nil {
		...
		*out = make(map[string]ClusterSubnet, len(*in))
		for key, val := range *in {
	...
	if in.LastReclamationTime != nil {
		in, out := &in.LastReclamationTime, &out.LastReclamationTime
		*out = (*in).DeepCopy()
	}
