...
func (in *AutoTopologyOptions) DeepCopyInto(out *AutoTopologyOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoTopologyOptions.
func (in *AutoTopologyOptions) DeepCopy() *AutoTopologyOptions {
	if in == nil {
		return nil
	}
	out := new(AutoTopologyOptions)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConnectivityEntry) DeepCopyInto(out *ConnectivityEntry) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectivityEntry.
func (in *ConnectivityEntry) DeepCopy() *ConnectivityEntry {
	if in == nil {
		return nil
	}
	out := new(ConnectivityEntry)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HubSpokeConfig) DeepCopyInto(out *HubSpokeConfig) {
	*out = *in
	if in.HubClusters != nil {
		in, out := &in.HubClusters, &out.HubClusters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SpokeClusters != nil {
		in, out := &in.SpokeClusters, &out.SpokeClusters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SpokeConnectivity != nil {
		in, out := &in.SpokeConnectivity, &out.SpokeConnectivity
		*out = make([]ConnectivityEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HubSpokeConfig.
func (in *HubSpokeConfig) DeepCopy() *HubSpokeConfig {
	if in == nil {
		return nil
	}
	out := new(HubSpokeConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SliceConfigSpec) DeepCopyInto(out *SliceConfigSpec) {
	*out = *in
	...
	if in.TopologyConfig != nil {
		in, out := &in.TopologyConfig, &out.TopologyConfig
...
func (in *TopologyConfig) DeepCopyInto(out *TopologyConfig) {
	*out = *in
	if in.HubSpoke != nil {
		in, out := &in.HubSpoke, &out.HubSpoke
		*out = new(HubSpokeConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.ConnectivityMatrix != nil {
		in, out := &in.ConnectivityMatrix, &out.ConnectivityMatrix
		*out = make([]ConnectivityEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	...
	if in.AutoOptions != nil {
		in, out := &in.AutoOptions, &out.AutoOptions
		*out = new(AutoTopologyOptions)
		**out = **in
	}
}
