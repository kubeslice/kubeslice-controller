...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForbiddenEdge) DeepCopyInto(out *ForbiddenEdge) {
	*out = *in
	if in.TargetClusters != nil {
		in, out := &in.TargetClusters, &out.TargetClusters
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForbiddenEdge.
func (in *ForbiddenEdge) DeepCopy() *ForbiddenEdge {
	if in == nil {
		return nil
	}
	out := new(ForbiddenEdge)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TopologyConfig) DeepCopyInto(out *TopologyConfig) {
	*out = *in
	...
	if in.ForbiddenEdges != nil {
		in, out := &in.ForbiddenEdges, &out.ForbiddenEdges
		*out = make([]ForbiddenEdge, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
